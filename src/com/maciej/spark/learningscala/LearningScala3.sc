object LearningScala3 {
  ...
  // Basically every function in Scala is kind of a little object and we can pass these functions around
  // to other functions like they are objects themselves.
  ...
  def transformWord(word : String, f: String => String) : String = {
    f(word)
  }

  val upperCaseWord = transformWord("hello world", word => word.toUpperCase)
