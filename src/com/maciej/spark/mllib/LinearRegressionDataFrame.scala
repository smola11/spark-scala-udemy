package com.maciej.spark.mllib
...
object LinearRegressionDataFrame {
  ...
  def main(args: Array[String]) {
    ...
    val df = data.toDF(colNames: _*) // we are passing a sequence of stuff
    ...
    val trainTest = df.randomSplit(Array(0.5, 0.5)) // we receive 2 DataFrames
