...
object MovieSimilarities {
  ...
  def filterDuplicates(userRatings: UserRatingPair): Boolean = {
    ...
    return movie1 < movie2 // we eliminate one of (A,B) (B,A) pair as well as (A,A) like pairs
  }
  ...
  def main(args: Array[String]) {
    ...
    // Self-join to find every combination. We receive every permutation of combinations of movies.
